            ...
            <div id="homescreen">
                ...
                <div id="contacts">
                    <div class="contact">
                        ...
                        <div class="status_positive"> 
                            <img src="Projekt_grafiki/Kontakty/Przyciski_emotki/PNG/emotka_zla_dobra_kontakty.png" class = "positive_icon">
                        </div>
                    </div>
                    <div class="contact">
                        <div class="avatar">
